...
pub enum StakeBobInstruction {
    ...
    #[account(7, name="nft_edition", desc = "The master edition account for the NFT to be staked")]
    #[account(8, writable, name="nft_token_account", desc = "The token account for the NFT to be staked")]
    #[account(9, writable, name="stake_manager_pda", desc = "The stakeBOB stake manager account")]
    #[account(10, writable, name="stake_status_pda", desc = "The new stake status PDA account")]
    Stake(StakeArgs),
    ...
    #[account(4, name="nft_metadata", desc = "The token metadata for the NFT to be unstaked")]
    #[account(5, name="nft_mint", desc = "The mint for the NFT to be unstaked")]
    #[account(6, name="nft_edition", desc = "The master edition marker account for the NFT to be unstaked")]
    #[account(7, writable, name="nft_token_account", desc = "The token account for the NFT to be unstaked")]    
    #[account(8, writable, name="stake_manager_pda", desc = "The stakeBOB stake manager account")]
    #[account(9, writable, name="stake_status_pda", desc = "The stake status PDA account")]
    Unstake(UnstakeArgs),
}
